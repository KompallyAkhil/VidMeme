...
export default function VideoUploader({ onVideoLoaded, videoName, onRemove }: VideoUploaderProps) {
  ...
  if (videoName) {
    return (
      <div className="flex items-center justify-between gap-2 bg-white/[0.04] border border-white/[0.08] rounded-lg px-3 py-2.5 text-xs text-brand-secondary">
        <span>🎬</span>
